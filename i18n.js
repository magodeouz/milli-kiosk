(function () {
  ...
  const I18N_DICT = {
    tr: {
      ...
      "home.login.account": "Hesap Bilgileri ile Giriş",
      "home.cardScan.title": "Kimlik Kartınızı Okutun",
      "home.cardScan.description": "Kimlik kartınızı barkod okuyucuya gösterin",
      "home.cardScanned.title": "Kimlik Kartı Okutuldu",
      "home.cardScanned.select": "Kullanıcı tipini seçin",
      "home.cardScanned.newUser": "1. Yeni Gelen",
      "home.cardScanned.breakUser": "2. Moladaki Kullanıcı",
      "home.cardScanned.insideUser": "3. İçerideki Kullanıcı",
      "home.cardScanned.penalizedUser": "4. Cezalı Kullanıcı",
      "home.loading": "Yönlendiriliyor...",
      "home.otherOptions": "Diğer Giriş Seçenekleri",
      "home.barcodeHint": "Barkod okuyucuya gösterin",
    ...
    en: {
      ...
      "home.login.account": "Sign in with Account Info",
      "home.cardScan.title": "Scan Your ID Card",
      "home.cardScan.description": "Show your ID card to the barcode reader",
      "home.cardScanned.title": "ID Card Scanned",
      "home.cardScanned.select": "Select user type",
      "home.cardScanned.newUser": "1. New Visitor",
      "home.cardScanned.breakUser": "2. User on Break",
      "home.cardScanned.insideUser": "3. User Inside",
      "home.cardScanned.penalizedUser": "4. Penalized User",
      "home.loading": "Redirecting...",
      "home.otherOptions": "Other Sign-in Options",
      "home.barcodeHint": "Show to barcode reader",
    ...
    ar: {
      ...
      "home.login.account": "تسجيل الدخول بمعلومات الحساب",
      "home.cardScan.title": "امسح بطاقة هويتك",
      "home.cardScan.description": "اعرض بطاقة هويتك على قارئ الباركود",
      "home.cardScanned.title": "تم مسح بطاقة الهوية",
      "home.cardScanned.select": "اختر نوع المستخدم",
      "home.cardScanned.newUser": "1. زائر جديد",
      "home.cardScanned.breakUser": "2. مستخدم في استراحة",
      "home.cardScanned.insideUser": "3. مستخدم داخل المكتبة",
      "home.cardScanned.penalizedUser": "4. مستخدم معاقب",
      "home.loading": "جاري إعادة التوجيه...",
      "home.otherOptions": "خيارات تسجيل الدخول الأخرى",
      "home.barcodeHint": "اعرض على قارئ الباركود",
